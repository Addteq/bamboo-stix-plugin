package com.addteq.bamboo.plugin.servlet;
 ...
 *
 * This servlet can be reached at http://localhost:2990/jira/plugins/servlet/com.addteq.bamboo.plugin/license
 */
public class LicenseServlet extends HttpServlet
{
    ...
    private Map<String, Object> initVelocityContext(HttpServletResponse resp)
    {
        ...
        URI servletUri = URI.create(applicationProperties.getBaseUrl() + "/plugins/servlet/com.addteq.bamboo.plugin/license");
